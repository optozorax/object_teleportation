...
export class MeshHandle {
    ...
    set_constant(name, value) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.meshhandle_set_constant(this.__wbg_ptr, ptr0, len0, value);
    }
    /**
     * @returns {number}
     */
    get_particles_buffer() {
        const ret = wasm.meshhandle_get_particles_buffer(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_particles_count() {
        const ret = wasm.meshhandle_get_particles_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_lines_buffer() {
        const ret = wasm.meshhandle_get_lines_buffer(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_lines_count() {
        const ret = wasm.meshhandle_get_lines_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_disable_lines_buffer() {
        const ret = wasm.meshhandle_get_disable_lines_buffer(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_circle1_data() {
        const ret = wasm.meshhandle_get_circle1_data(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
